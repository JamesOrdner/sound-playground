...
void SubjectInterface::eventImmediate(EventType event, const EventData& data, bool bEventFromParent) const
{
	StateManager::instance().eventImmediate(this, event, data, bEventFromParent);
}
